...
function Shell() {
    ...
    useEffect(() => {
        if (sessionToken && location.pathname !== '/' && location.pathname !== '/signup') {
            fetchUnreadCount();
        ...
        <div className="App">
            <ThemeProvider theme={defaultTheme}>
                <Box sx={{ display: 'flex' }}>
                    ...
                    <Routes>
                        <Route path="/" element={<Login updateToken={updateLocalToken} setUserId={updateLocalUserId} setUsername={setUsername} />} />
            ...
            <NotificationModal isOpen={isModalOpen} onClose={toggleModal} fetchUnreadCount={fetchUnreadCount} />
        </div>
    );
}
